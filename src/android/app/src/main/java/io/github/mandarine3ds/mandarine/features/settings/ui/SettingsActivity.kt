...
import io.github.mandarine3ds.mandarine.databinding.ActivitySettingsBinding
...
class SettingsActivity : AppCompatActivity(), SettingsActivityView {
    ...
    fun onSettingsReset() {
        ...
        val editor =
            PreferenceManager.getDefaultSharedPreferences(MandarineApplication.appContext).edit()
