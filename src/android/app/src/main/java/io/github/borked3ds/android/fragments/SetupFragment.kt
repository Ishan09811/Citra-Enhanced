...
import io.github.borked3ds.android.adapters.SetupAdapter
import io.github.borked3ds.android.databinding.FragmentSetupBinding
...
class SetupFragment : Fragment() {
        ...
        pages.apply {
            ...
            add(
                SetupPage(
                    ...
                    R.string.select_borked3ds_user_folder_description,
                    0,
                    true,
                    R.string.select,
                    {
                        userDirCallback = it
                        openBorked3DSDirectory.launch(null)
                    },
                    true,
                    true,
                    {
    ...
    private val openBorked3DSDirectory = registerForActivityResult<Uri, Uri>(
